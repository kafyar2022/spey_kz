  ...
  <main class="news-create-page">
    <form class="form" action="{{ route('news.create') }}" method="post" enctype="multipart/form-data">
      ...
      <fieldset class="form__element form__element--long form__element--photo">
        ...
        <img class="form__photo-preview" src="{{ asset('img/products/muffin-grey.svg') }}" alt="Фотография новости" width="40" height="44">
      ...
      <fieldset class="form__element form__element--wide form__element--news-rutitle">
        ...
        <input class="form__input" type="text" name="ru-title" id="ru-title" placeholder="Заголовок новости на русском языку" autocomplete="off" required>
      </fieldset>
      <fieldset class="form__element form__element--news-entitle">
        ...
        <input class="form__input" type="text" name="en-title" id="en-title" autocomplete="off" placeholder="News headline in English" required>
      </fieldset>
